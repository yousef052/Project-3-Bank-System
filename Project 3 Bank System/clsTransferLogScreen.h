...
private:
	...
	static void _PrintTransferLogRecordLine(clsBankClient::stTransferLogRecord
		TransferLogRecord)
	{
		cout << setw(8) << left << "" << "| " << setw(23) << left <<
...
public: 
	...
	static void ShowTransferLogScreen()
	{
		...
		if (vTransferLogRecord.size() == 0)
			...
			for (clsBankClient::stTransferLogRecord
				Record : vTransferLogRecord)
			{
