...
private:
	...
	static stLoginRegisterRecord _ConvertRegisterLineToRecord(string Line,
		string Seperator = "#//#")
	{
		...
		string Seperator = "#//#")
	{
		...
		vUserData[2], vUserData[3], vUserData[4], clsUtil::DecryptText(vUserData[5])
			, stoi(vUserData[6]));
	...
	static vector <stLoginRegisterRecord> GetLoginRegisterList()
	{
		...
		if (MyFile.is_open())
		{
			...
			while (getline(MyFile, Line))
			{
				...
				LoginRegisterRecord = _ConvertRegisterLineToRecord(Line);
