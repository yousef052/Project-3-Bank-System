...
private:
	...
	static void _PerformTransactionsMenueOption(enTransactionsMenueOption
		TransactionsMenueOption)
	{
...
public:
	...
	static void ShowTransactionsMenue()
	{
		...
		_PerformTransactionsMenueOption((enTransactionsMenueOption)
			_ReadTransactionsMenueOption());
